...
- [x] 3.1 `npm run lint` exits 0 on the current codebase. — 3963314
- [x] 3.2 Deliberately adding the import to any of the four scoped files causes lint to fail with the plan-referenced message. Revert. — 3963314
- [x] 3.3 `src/pages/api/account/delete.ts` still lints clean. — 3963314

#### Manual

- [x] 3.4 The "deliberately add the import" experiment on each of `flashcard.service.ts`, `review.service.ts`, and `src/pages/api/flashcards/index.ts` fails lint. Revert each. — 3963314
