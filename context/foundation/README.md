...
When a foundation doc is fully superseded - replaced by a new approach rather than refined - move it to oundation/archive/YYYY-MM-DD-<doc>.md and write the replacement at the original path. The archive folder is a historical record; nothing reads from it routinely.
