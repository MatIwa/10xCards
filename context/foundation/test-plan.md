...
|---|---|---|---|---|---|---|
| 1 | Bootstrap runner + AI generation critical path | Install Vitest, wire the first test infra, and prove Risks #1 and #2 at the cheapest layer that catches them | #1, #2 | unit + integration | change opened | `context/changes/testing-ai-generation-critical-path/` |
...
TBD — see §3 Phase 1 (Vitest bootstrap will fix the location, naming convention, and run command; the reference test will be the first parser test for Risk #1).
